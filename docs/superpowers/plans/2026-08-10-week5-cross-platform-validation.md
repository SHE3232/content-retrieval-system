...
Search, results, settings, semantic navigation, contrast, and text scaling remain usable on Android/Web. File-open action is disabled with a tooltip explaining the platform limitation; copy path remains available.
